...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const products = {
        'HK-1': {
            ...
            name: 'Hollow Knight',
            price: 20490,
            image: '../assets/imagens/hollow-knight.jpg'
        },
        'GOW-2': {
            id: 'GOW-2',
            name: 'God Of War Ragnarök',
            price: 59490,
            image: '../assets/imagens/god-of-war.jpg'
        }
    ...
    // Llenar el botón con los datos del producto
...
function initAddToCartButton() {
  ...
  addToCartBtn.addEventListener("click", () => {
    ...
    addToCart(productData);       // usa la función global de carrito.js
    showAddToCartFeedback(addToCartBtn);
  });

  console.log("✅ Botón de detalle configurado:", addToCartBtn.dataset.productName);
}
...
function updateCartCounter() {
    ...
    if (cartCounter) {
        const cart = JSON.parse(localStorage.getItem('ecommerce-cart-data')) || [];
