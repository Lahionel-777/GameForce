...
function addToCartFromCatalog(productData) {
    ...
    let cart = JSON.parse(localStorage.getItem('ecommerce-cart-data')) || [];
    ...
    localStorage.setItem('ecommerce-cart-data', JSON.stringify(cart));
...
function updateCartCounter() {
    if (typeof window.updateCartDisplay === 'function') {
        ...
        console.warn('⚠️ Función global updateCartDisplay no disponible');
    }
}
